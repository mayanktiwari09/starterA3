...
func (d *KVS) Start(localTracer *tracing.Tracer, clientId string, CoordIP string, ChCapacity int) (NotifyChannel, error) {
...
// If there is an issue with stopping, this should return an appropriate err value, otherwise err should be set to nil.
func (d *KVS) Stop() error {
